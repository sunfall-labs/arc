...
const sharedAlias = {
  ...
  "@effect-ui/start/fetch-adapter": new URL("./packages/start/src/fetch-adapter.ts", import.meta.url).pathname,
  "@effect-ui/start/node-adapter": new URL("./packages/start/src/node-adapter.ts", import.meta.url).pathname,
