...
/**
 * Reads a signal or already-loaded resource ref at a render/host-adapter seam.
 *
 ...
 * loads. Effect code should prefer Resource.readEffect for resource refs.
 */
export function read<A>(value: ReadableSignal<A>): A;
export function read<I, A, E, R>(value: Resource.Ref<I, A, E, R>): A;
