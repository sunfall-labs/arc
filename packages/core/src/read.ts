...
/**
 * Reads a signal or resource ref in render code.
 *
 * Signals return their current value. Resource refs delegate to Resource.read, which
 * may throw a Promise for suspense or ResourceFailure for failed loads.
 */
