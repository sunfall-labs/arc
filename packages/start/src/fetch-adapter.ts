...
type StartFetchRuntimeRequirements<Requirements> = unknown extends Requirements
  ? never
 ...
 */
export type StartFetchPromiseHandlerRuntimeOptions<Requirements, RuntimeError = never> = Omit<
  StartFetchPromiseHandlerOptions<RuntimeError>,
  "runtime"
> & {
...
type StartFetchPromiseHandlerOptionsArgs<Requirements, RuntimeError = never> = [
  StartFetchRuntimeRequirements<Requirements>,
] extends [never]
...
>(
  handler: Handler,
  ...args: StartFetchPromiseHandlerOptionsArgs<
    StartRequestHandlerRequirements<Handler>,
    RuntimeError
  >
