...
const startAgentGraphQueryKindSet = new Set<StartAgentGraphQueryKind>(startAgentGraphQueryKinds);

/** Checks whether an argv value is one of the Start agent graph query kinds. */
export const isStartAgentGraphQueryKind = (value: string): value is StartAgentGraphQueryKind =>
...
export const startAgentGraphQueryKindsText = (): string => startAgentGraphQueryKinds.join(", ");
...
): StartAgentGraphImpactRelationKind => relationKindByNodeKind[kind];
