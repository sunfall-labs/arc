...
export const queryContextIdentitySymbol: unique symbol = Symbol.for("@effect-ui/db/QueryContextKey") as typeof queryContextIdentitySymbol;
...
export const querySourceContextIdentity = (
  ...
  makeQueryContextIdentity([alias, typeof key, key]);

export const queryCollectionRowIdentity = (
  key: CollectionKey
): QueryContextIdentity =>
...
export const queryContextIdentityOf = (
  context: unknown
): QueryContextIdentity | undefined =>
  typeof context === "object" && context !== null &&
  queryContextIdentitySymbol in context
