...
type RejectCollectionPromiseOutput<Out> = [Out] extends [never]
  ? unknown
  : EnsureEffectInput<Out> extends never
    ? never
    : unknown;

type RejectCollectionPromiseOutputs<Definition> = RejectCollectionPromiseOutput<
  CollectionOptionalReturn<Definition, "load">
> &
...
export namespace Collection {
  ...
  export type Change<A extends object, K extends CollectionKey = CollectionKey> = CollectionChange<
    A,
    K
  >;
  ...
  export type ResourceSyncAdapterOptions<
    I,
    A extends object,
    K extends CollectionKey = string,
    E = never,
  ...
  export type QuerySyncFetchOptions<
    A extends object,
    E = never,
    R = never,
  ...
  export type QuerySyncClient<A extends object, E = never, R = never> = CollectionQuerySyncClient<
    A,
    E,
    R
  >;
  /** Options for adapting a query client into a collection sync adapter. */
  export type QuerySyncAdapterOptions<
    A extends object,
    K extends CollectionKey = string,
    E = never,
    R = never,
  ...
  export type FlushAllPendingMutationsSkip<
    SkipError = never,
  ...
  export type FlushAllPendingMutationsOptions<
    SkipError = never,
    SkipRequirements = never,
  ...
  export type BackgroundSyncAdapter<
    AdapterError = never,
  ...
  export type SQLiteStatementDatabase<E = never, R = never> = SQLitePersistenceStatementDatabase<
    E,
    R
  >;
  ...
  export type SQLitePreparedStatementDatabaseOptions =
  ...
  export const backgroundSyncPendingMutationsEffect =
    backgroundSyncCollectionsPendingMutationsEffect;
  ...
  >;
  export function define<A extends object, K extends CollectionKey = string, E = never, R = never>(
  ...
  export const diagnostics = (): CollectionDiagnostics => collectionDiagnostics();
  ...
  export const pendingMutationsEffect = <A extends object, K extends CollectionKey, E, R>(
    ...
    definition.pendingMutationsEffect();
  ...
  export const flushPendingMutationsEffect = <A extends object, K extends CollectionKey, E, R>(
    ...
    definition.flushPendingMutationsEffect();
  ...
  export const hydrateEffect = <A extends object, K extends CollectionKey, E, R>(
    ...
    definition.hydrateEffect(value, options);
  ...
  export const dehydrate = (collections: Iterable<AnyCollection>): CollectionHydrationPayload =>
    dehydrateCollections(collections);
  ...
  export const dehydrateEffect = (
    ...
    CollectionHydrationPayload,
    CollectionSnapshotCodecError | EffectInputCallbackError
  > => dehydrateCollectionsEffect(collections);
  ...
  export const hydratePayloadEffect = (
    ...
    hydrateCollectionsEffect(collections, payload, options);
  ...
  export const validateHydrationPayloadEffect = (
    ...
    validateCollectionsHydrationEffect(collections, payload, options);
  ...
  export const applyChangesEffect = <A extends object, K extends CollectionKey, E, R>(
    ...
    applyCollectionChangesEffect(definition, changes, options);
  ...
  >(
    ...
    void,
    CollectionRuntimeError<E> | FeedError,
    R | FeedRequirements | Scope.Scope
  ...
  >(
    ...
    definition.persistEffect(storage, options);

  /**
   * Restore one collection snapshot from storage if present.
   */
  export const restoreEffect = <
    A extends object,
    K extends CollectionKey,
    E,
    R,
