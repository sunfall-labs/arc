  ...
  },
  {
    ...
    required: [
      ...
      },
      {
        ...
        pattern: new RegExp(
          `active Thirty-Sweep clean counter is ${activeCleanCounterPattern} after\\s+Clean Sweep 1 after\\s+Review${currentDocsEvidencePolicy.latestFocusedReview}`,
        ),
      },
    ],
    banned: [
  ...
  },
  {
    ...
    required: [
      ...
      },
      {
        ...
        pattern: new RegExp(
          `active\\s+Thirty-Sweep\\s+clean counter is ${activeCleanCounterPattern} after\\s+Clean Sweep 1 after\\s+Review${currentDocsEvidencePolicy.latestFocusedReview}`,
        ),
      },
    ],
    banned: [
