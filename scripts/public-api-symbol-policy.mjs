  ...
  },
  {
    ...
    required: [
      ...
      },
      {
        ...
        pattern: new RegExp(
          `active\\s+Thirty-Sweep\\s+clean\\s+counter\\s+is ${activeCleanCounterPattern} after\\s+Clean\\s+Sweep\\s+3\\s+after\\s+Review${currentDocsEvidencePolicy.latestFocusedReview}`,
        ),
      },
    ],
    banned: [
  ...
  },
  {
    ...
    required: [
      ...
      },
      {
        ...
        pattern: new RegExp(
          `Clean Sweep 3 after Review${currentDocsEvidencePolicy.latestFocusedReview}\\s+found no actionable`,
        ),
      },
    ],
    banned: [
  ...
  },
  {
    ...
    required: [
      ...
      },
      {
        ...
        pattern: new RegExp(
          `counter is ${activeCleanCounterPattern} after Clean Sweep 3 after Review${currentDocsEvidencePolicy.latestFocusedReview}`,
        ),
      },
    ],
    banned: [
