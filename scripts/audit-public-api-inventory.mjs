  ...
  const currentDocsSelfTestPolicy = {
    ...
    required: [
      ...
      },
      {
        ...
        pattern: new RegExp(
          `${currentDocsEvidencePolicy.activeCleanCounter} after\\s+Clean Sweep 6 after Review${latestFocusedReview}`,
        ),
      },
      {
    ...
    banned: [
      ...
      },
      {
        ...
        pattern: new RegExp(
          `${staleCleanCounter} after\\s+Clean Sweep 6 after Review${staleFocusedReview}`,
        ),
      },
      {
