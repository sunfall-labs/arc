...
- [x] `pnpm verify` latest result recorded.
  - Evidence: root `pnpm verify` passed on May 15, 2026 after the Review 114
    Start Diagnostics CLI Query Kind Subcommands slice: 11 package builds,
    workspace typecheck, type tests, public API inventory audit, Effect-first
    audit over 226 files,
