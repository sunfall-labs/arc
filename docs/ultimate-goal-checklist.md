...
- [x] `pnpm verify` latest result recorded.
  - Evidence: root `pnpm verify` passed on May 15, 2026 after the Review 86
    Public API Type-Test Manifest: 11 package builds, workspace typecheck,
    type tests, public API inventory audit, Effect-first audit over 216 files,
