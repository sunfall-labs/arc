...
- The latest full gate is the Review 151 `pnpm verify` run: 11 package builds,
...
- Review 135 tightened the Start fetch adapter Promise-return allowance while
  ...
  files.
- The latest full `pnpm verify` passed after the Review 151 Core State
  Presence, Source Package Gates, And DB/Start Seams slice: 11 package builds,
