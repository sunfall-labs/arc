...
- The latest full `pnpm verify` passed after the Review 89 Collection Value
  Detachment Module: 11 package builds, workspace typecheck, type tests,
  public API inventory audit, Effect-first audit over 218
  ...
  scanner green over the expanded public type-test scope, and Review 89 kept
  the Effect-first scanner green over its expanded 218-file scope.
